...
class EntrostopScreen extends StatefulWidget {
  const EntrostopScreen({Key? key}) : super(key: key);

  @override
  State<EntrostopScreen> createState() => _EntrostopScreenState();
}

class _EntrostopScreenState extends State<EntrostopScreen> {
  int _currentIndex = 0;
      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: const Text(
              "Entrostop mengandung obat antidiare berupa attapulgite dan pectin. Sementara itu, Entrostop Herbal Anak mengandung bahan alami, seperti ekstrak daun jambu biji, daun teh hijau camelia, jahe, dan ekstrak kunyit. Kombinasi bahan-bahan tersebut dipercaya dapat meredakan gejala diare. Tiap tablet Entrostop mengandung 650 mg attapulgite dan 50 mg pectin.",
